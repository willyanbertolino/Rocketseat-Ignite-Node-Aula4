...
import { AnswersAttachmentRepository } from "../repositories/answer-attachments-repository";
...
export class EditAnswerUseCase {
    ...
    async execute({ answerId, authorId, content, attachmentsIds }: EditAnswerUseCaseRequest): 
        ...
        const currentAnswerAttachment = await this.answersAttachmentRepository
